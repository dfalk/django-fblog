...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fblog_entrycategory', (
        ...
        db.send_create_signal('fblog', ['EntryCategory'])

        # Adding model 'Entry'
        db.create_table('fblog_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='author', to=orm['auth.User'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fblog.EntryCategory'], null=True, blank=True)),
        ...
        db.send_create_signal('fblog', ['Entry'])


    def backwards(self, orm):
        
        # Deleting model 'EntryCategory'
        db.delete_table('fblog_entrycategory')

        # Deleting model 'Entry'
        db.delete_table('fblog_entry')
